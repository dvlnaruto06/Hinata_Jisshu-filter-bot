...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002583655280'))  # set shortner log channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002635477308')) # The movie you upload in it will be deleted from the bot.
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '0'))
auth_channel = environ.get('AUTH_CHANNEL', '-1002282783745 -1002594005991 -1002393557941')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002517228726'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002655119999') # If anyone sends a request message to your bot, you will get it in this channel.
